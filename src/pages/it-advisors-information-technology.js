        ...
        <div className="container">
          ...
          <div className="row">
            ...
            <div className="col-md-9 detail-blk txt-justify singel-blk">
              <h2 className="in-heading">INFORMATION TECHNOLOGY ADVISORS</h2>
...
export async function getStaticProps() {
  ...
  const url = `https://${process.env.NEXT_PUBLIC_URL}/jsonapi/node/team?filter[field_category.id][value]=1d17106a-8ecb-4bec-9e79-8df3b9f7741c&include=field_image`;
  console.log(url);
