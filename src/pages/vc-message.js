...
export async function getStaticProps() {
	...
	const url = `https://${process.env.NEXT_PUBLIC_URL}/jsonapi/node/page/79c4b6ee-5b9c-418a-9bfb-78524c80320a`;
	console.log(url);
