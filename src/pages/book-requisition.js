...
function Admission({ posts }) {
  ...
  const handleSubmit1 = async (event) => {
    ...
    const formData = {
      ...
      NoOfCopy: copyRef.current.value,
      agree: agreeRef.current.value,
      type: "Book Requisition  Form",
    };
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-9 ask_librarian">
              <h3 className="section-header">BOOK REQUISITION</h3>
...
export async function getStaticProps() {
  ...
  const url = `https://${process.env.NEXT_PUBLIC_URL}/jsonapi/node/page/115407fe-c78e-48c0-aaa8-0fea27cb9423`;
  console.log(url);
