				...
				<div className="container">
					...
					<div className="row">
						...
						<div className="col-md-9 detail-blk txt-justify singel-blk">
							<h2 className="in-heading">STAFF IN SCHOLARSHIP SECTION</h2>
...
export async function getStaticProps() {
	...
	const url = `https://${process.env.NEXT_PUBLIC_URL}/jsonapi/node/page/894d8197-9b1e-4ead-86ac-460879529c33`;
	console.log(url);
