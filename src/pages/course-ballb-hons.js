			...
			<section className="page-content-sec course-ballb-hons">
				<div className="container">
					<div className="row">
						...
						<div class="col-md-9 detail-blk txt-justify singel-blk">
							<h2 className="in-heading">B.A.LL.B. (HONS.)</h2>
							<div
								className="course-ballb-hons"
...
export async function getStaticProps() {
	...
	const url = `https://${process.env.NEXT_PUBLIC_URL}/jsonapi/node/page/b2fb2c3d-5f57-4ee7-828f-b2ba36a229f1`;
	console.log(url);
