...
function ManagementDepartmentBbaLlbHons({ posts }) {
  ...
  return (
    <div>
      ...
      <section className="page-content-sec b-b-a-m-b-a-programme">
        <div className="container">
...
export async function getStaticProps() {
  ...
  const url = `https://${process.env.NEXT_PUBLIC_URL}/jsonapi/node/page/24ceac09-7c06-4b6a-9af7-043567ed69af`;
  console.log(url);
