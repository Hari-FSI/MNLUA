					...
					<div className="row">
						...
						<div className="col-md-9 detail-blk txt-justify singel-blk">
							<h2 className="in-heading">
								MEMBERS OF THE ACADEMIC COUNCIL [UNDER SECTION 22 (1)] (WITH
								EFFECT FROM 28TH NOVEMBER, 2022)
							</h2>
...
export async function getStaticProps() {
	...
	const url = `https://${process.env.NEXT_PUBLIC_URL}/jsonapi/node/page/1916a695-ba4b-48e0-bf71-bf11c966291a`;
	console.log(url);
