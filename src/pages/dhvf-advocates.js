				...
				<div className="container">
					...
					<div className="row">
						...
						<div className="col-md-9 detail-blk txt-justify singel-blk">
							<h2 className="in-heading">ADVOCATES</h2>
...
export async function getStaticProps() {
	...
	const url = `https://${process.env.NEXT_PUBLIC_URL}/jsonapi/node/team?filter[field_category.id][value]=bd640f4c-539c-47dc-9e2c-4b9023c05b93&include=field_image`;
	console.log(url);
