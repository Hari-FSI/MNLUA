				...
				<div className="container">
					...
					<div className="row">
						...
						<div className="col-md-9 detail-blk txt-justify singel-blk">
							<h2 className="in-heading">EXECUTIVE</h2>
...
export async function getStaticProps() {
	...
	const url = `https://${process.env.NEXT_PUBLIC_URL}/jsonapi/node/team?filter[field_category.id][value]=8ecac06f-fa5f-43ba-b4bf-6e5222cab6c8&include=field_image`;
	console.log(url);
