				...
				<div className="container">
					...
					<div className="row">
						...
						<div className="col-md-9 detail-blk txt-justify singel-blk">
							<h2 className="in-heading">ACADEMICS</h2>
...
export async function getStaticProps() {
	...
	const url = `https://${process.env.NEXT_PUBLIC_URL}/jsonapi/node/team?filter[field_category.id][value]=f5d7eb98-8abb-40e3-b87b-df7fe1cc6ec7&include=field_image`;
	console.log(url);
