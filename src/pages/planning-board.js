          ...
          <div className="row">
            ...
            <div className="col-md-9 detail-blk txt-justify singel-blk">
              <h2 className="in-heading">
                MEMBERS OF THE PLANNING BOARD (UNDER SECTION 25 A (I) AND (II))
              </h2>
...
export async function getStaticProps() {
  ...
  const url = `https://${process.env.NEXT_PUBLIC_URL}/jsonapi/node/page/bcdea531-e2b1-4fe5-985a-4af341b34544`;
  console.log(url);
